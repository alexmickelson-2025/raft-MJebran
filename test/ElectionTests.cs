...
public class LeaderElectionTests
{
    ...
    public void TestLeaderRecognition_RemembersLeaderOnAppendEntries()
    {
        ...
        var appendEntries = new AppendEntriesRPCDTO(leaderId, 1, new List<LogEntry>(), commitIndex: 0);
    ...
    public void TestAppendEntriesResponse_SendsResponseOnRequest()
    {
        // Arrange
        var node = new RaftNode();
        var appendEntries = new AppendEntriesRPCDTO(Guid.NewGuid(), 1, new List<LogEntry>(), commitIndex: 0);
    ...
    public void TestVotingForPreviousTerm_VotesYes()
    {
        ...
        var requestForVote = new RequestForVoteRPCDTO(term: 2, candidateId: Guid.NewGuid());
    ...
    public void TestFollowerReceivesLaterTermAppendEntries_BecomesFollower()
    {
        ...
        var appendEntries = new AppendEntriesRPCDTO(Guid.NewGuid(), term: 2, new List<LogEntry>(), commitIndex: 0);
    ...
    public void TestFollowerResetsElectionTimerOnAppendEntries()
    {
        ...
        var appendEntries = new AppendEntriesRPCDTO(Guid.NewGuid(), term: 1, new List<LogEntry>(), commitIndex: 0);
    ...
    public void TestFollowerVotesForRequestInEarlierTerm()
    {
        ...
        var requestForVote = new RequestForVoteRPCDTO(term: 2, candidateId: candidateId);
    ...
    public void TestCandidateBecomesFollowerOnAppendEntriesWithEqualTerm()
    {
        ...
        var leaderId = Guid.NewGuid();
        var appendEntries = new AppendEntriesRPCDTO(leaderId, term: 2, new List<LogEntry>(), commitIndex: 0);
    ...
    public void TestRejectsDuplicateVoteRequestForSameTerm()
    {
        ...
        var requestForVote = new RequestForVoteRPCDTO(term: 3, candidateId: newCandidateId);
    ...
    public void TestVotesForFutureTermRequest()
    {
        ...
        var candidateId = Guid.NewGuid();
        var requestForVote = new RequestForVoteRPCDTO(term: futureTerm, candidateId: candidateId);
    ...
    public async Task TestElectionRestartOnTimerExpiry()
    {
        ...
        Assert.Equal(3, node.CurrentTerm);
        Assert.False(node.HasVotedFor(node.Id));
    }
    ...
    public void TestFollowerSendsResponseToAppendEntries()
    {
        ...
        var leaderId = Guid.NewGuid();
        var appendEntries = new AppendEntriesRPCDTO(leaderId, term: 3, new List<LogEntry>(), commitIndex: 0);
    ...
    public void TestCandidateRejectsAppendEntriesFromPreviousTerm()
    {
        ...
        var node = new RaftNode { State = NodeState.Candidate, CurrentTerm = 3 };
        var leaderId = Guid.NewGuid();
        var appendEntries = new AppendEntriesRPCDTO(leaderId, term: 2, new List<LogEntry>(), commitIndex: 0); // Term is lower than current term
